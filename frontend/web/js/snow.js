...
/**
 * Created by Bohdan on 15.12.2015.
 */
var snowStorm = null;
function SnowStorm() {
    ...
    var imagePath = imageDir ? imageDir : '/wp-content/uploads/snow/'; // relative path to snow images (including trailing slash)
    ...
    var zIndex = 60; // CSS stacking order applied to each snowflake
